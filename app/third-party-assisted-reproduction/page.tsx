...
const FALLBACK_SEO = {
  title: "第三方辅助生殖咨询与合法合规方案 | 天悦宝贝",
  description:
    "天悦宝贝提供第三方辅助生殖咨询服务，涵盖海外合法合规方案、法律政策解读、医学评估、流程协调与全程陪伴，帮助家庭在合法合规前提下了解可行的辅助生殖选择。",
};
...
function generateTocFromContent(
  blocks?: ThirdPartyAssistedReproductionPage["contentBlocks"]
) {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    pathname: "/third-party-assisted-reproduction",
    seo,
    siteSettings,
...
function ContentBlockRenderer({
  ...
  block: NonNullable<ThirdPartyAssistedReproductionPage["contentBlocks"]>[number];
  index: number;
}) {
...
export default async function ThirdPartyAssistedReproductionPage() {
  ...
  // 最终 CTA
  const finalCta = {
    title: p?.finalCtaTitle || "开始了解第三方辅助生殖方案",
    description:
      p?.finalCtaDescription ||
      "专业的咨询顾问随时为您服务，帮助您了解合法合规的辅助生殖选择。",
