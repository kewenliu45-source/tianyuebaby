...
export const faqPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      of: [{ type: "bannerSlide" }],
      description: "前台位置：常见问题页面顶部轮播图区域。是否建议修改：建议改。修改效果：更换页面顶部大图及文案。注意：建议添加 1-3 张，桌面图建议 1920×600 像素，手机图建议 750×600 像素；前台为响应式 object-cover 背景图，会随屏幕宽高裁剪，主体请放中间安全区。",
    }),
