      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({ name: "image", title: "图片", type: "imageWithAlt", description: '前台位置：内容块配图。是否建议修改：建议改。修改效果：增强内容的视觉展示。注意：图文混排建议 800×600px；如模块类型为全宽图片，前台按 16:7 显示，建议 1600×700 或 1920×840px；主体居中。' }),
            defineField({
              name: "imagePosition",
              title: "图片位置",
              type: "string",
              ...
              of: [
                {
                  ...
                  fields: [
                    ...
                    defineField({ name: "image", title: "图片", type: "imageWithAlt", description: '前台位置：子项配图。是否建议修改：建议改。修改效果：增强子项视觉展示。注意：前台信息卡片多按 16:10 显示，建议 800×500 或 400×250px；如用于流程时间线宽图，建议 1600×700px。' }),
                  ],
                },
              ],
            }),
