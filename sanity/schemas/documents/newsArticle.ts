...
export const newsArticle = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "imageWithAlt",
      description:
        "前台位置：新闻列表页卡片缩略图。是否建议修改：建议改。修改效果：影响文章在列表中的视觉吸引力。注意：建议尺寸 1600×1000 像素（16:10）或更大，大小不超过 2MB；该图会用于新闻列表、首页推荐和相关推荐等不同容器，前台统一 object-cover，主体请居中，边缘可能被裁剪。",
    }),
    defineField({
      name: "excerpt",
      title: "摘要",
    ...
    defineField({
      ...
      description:
        "前台位置：文章详情页正文内容。是否建议修改：建议改。修改效果：决定文章详情页的完整内容。注意：支持富文本和内嵌图片；正文内嵌图片前台按 16:9 显示并使用 object-cover，建议 1280×720、1600×900 或 1920×1080，主体居中。",
    }),
    defineField({
      name: "publishedAt",
      title: "发布时间",
